...
#' @param median_scale scale the median absolute erro whe saving/reporting it. Useful in the circadian application to have a median absolute error in hours with phases in radiants.
